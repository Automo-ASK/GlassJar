...
FLW_BASE = os.environ.get("FLW_BASE", "https://f4bexperience.flutterwave.com").rstrip("/")
FORWARD_HEADERS = {"authorization", "content-type", "accept", "x-trace-id", "x-idempotency-key"}
